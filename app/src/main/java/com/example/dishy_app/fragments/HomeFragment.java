...
//        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(),2);
    ...
    private void initData() {
        ...
        mDishyList.add(new Dishy("Mì Trường Thọ", "https://images.pexels.com/photos/3026808/pexels-photo-3026808.jpeg?cs=srgb&amp;dl=asian-food-bowl-food-photography-3026808.jpg&amp;fm=jpg", "20 phút", 3, 5, "Trung bình", 50, mStep1, mMaterial1));
